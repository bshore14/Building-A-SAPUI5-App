...
sap.ui.controller("content.Main", {
        ...
        onInit: function() {
            ...
            if (shell.getContent().length === 0) {
                ...
                // workitems defined, otherwise we cannot load anything
        ...
        itemSelected: function(oEvent) {
            ...
            // the content, the second defines if we want to destroy old
            // content (if present) before adding the new content
            oShell.setContent(content, true);
        },
        
        // these functions get the correct page and create the view
        getContent: function(key) {
            var content = null;
            // because the application will have several pages,
            // we use the switch-case construct to check the key
            switch(key) {
            case "overview":
            ...
            case "salesOrders":
                ...
                content = sap.ui.view({
                    ...
                    // type of the view, i.e. XML, JS, JSON...
                    type: sap.ui.core.mvc.ViewType.XML
                });
                break;
            default:
